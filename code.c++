...
private:
    ...
    int bitcoin;
    int balance;
    int ethereum_value = 100;
    int bitcoin_value = 500;
...
public:
    ...
    void BuyCrypto() {
        ...
        if (option == 1 && balance >= ethereum_value) {
            ...
            transactions.push_back("Bought 1 Ethereum");
            cout << "Bought 1 Ethereum\n";
        } else if (option == 2 && balance >= bitcoin_value) {
            bitcoin++;
            balance -= bitcoin_value;
            transactions.push_back("Bought 1 Bitcoin");
            cout << "Bought 1 Bitcoin\n";
        } else {
